...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			'wide':		{ range: '-1680', href: '/static/helios/css/style-wide1.css', containers: 1200 },
			...
			'narrower': { range: '-840', href: '/static/helios/css/style-narrower.css', grid: { collapse: true } },
			'mobile':	{ range: '-736', href: '/static/helios/css/style-mobile.css', grid: { gutters: 16 }, viewport: { scalable: false } }
		},
		plugins: {
			layers: {
				config: {
